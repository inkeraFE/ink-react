(function (global, factory) {
  ...
  (global = global || self, factory(global.inkReact = {}, global.React, global.PropTypes, global.classNames));
  ...
  var Page = function Page(_ref) {
    ...
    return React__default.createElement(Flex, _extends({}, rest, {
      column: true,
      className: classNames({
        page: true,
        'page-white': white
      }, className)
    }), header && React__default.createElement(Flex, {
      column: true,
      none: true
    }, header), React__default.createElement(Flex, {
      flex: true,
    ...
    }, children), bottom, tabbar && React__default.createElement(Flex, {
      column: true,
      none: true,
  ...
  var Header = function Header(_ref) {
    ...
    }, left || React__default.createElement("div", null), center || React__default.createElement("div", null), right || React__default.createElement("div", null));
  };
  ...
  var Button = function Button(_ref) {
    ...
    return React__default.createElement("button", _extends({}, rest, {
  ...
  var Component = function Component(_ref) {
    ...
    return React__default.createElement("form", {
      ...
      onFocus: handleFocus
    }), canClear && show ? React__default.createElement("div", {
  ...
  var Carousel = function Carousel(_ref) {
    ...
    var isOutSide = function isOutSide(moveX, offsetWidth, _carouseLength) {
      return moveX > 0 || Math.abs(moveX) > offsetWidth * (_carouseLength - 1);
    };
    ...
    var fixLoop = function fixLoop(moveX) {
      var offsetWidth = carouselRef.current.offsetWidth;
      var preMoveX = preMX;
